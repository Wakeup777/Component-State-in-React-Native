...
// изменяем состояние внутри компонента описанного в виде функции
// с помощью хука из реакт
//хук принимает начальное состояние и возвращает текущее значение
//и метод который позволяет изменть текущие значение
